...
{	
	...
	{
		return EntityType.CREEPER != typeIn && EntityType.GHAST != typeIn  && EntityType.VILLAGER != typeIn && EntityType.PLAYER != typeIn && typeIn.getClass().isInstance(TamablePokemon.class);
	}*/
