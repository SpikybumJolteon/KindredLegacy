...
public class FirecrackerLittenSummonItem extends PoketamableSummonItem
{
	public FirecrackerLittenSummonItem(Properties properties)
	{
		super(properties);
	}
	...
	public static ItemStack fromPoketamableEntity(FirecrackerLittenEntity poketamableEntity)
	{
	...
	public static FirecrackerLittenEntity toPoketamableEntity(World world, ItemStack poketamableStack, PlayerEntity player)
	{
		FirecrackerLittenEntity poketamableEntity = KindredLegacyEntities.FIRECRACKER_LITTEN.create(world);

		applyEntityStats(poketamableEntity, poketamableStack, player);

		String name = poketamableStack.getTag() != null ? poketamableStack.getTag().getCompound("display").getString("Name") : "Firecracker Litten";
