...
public class OkamiSylveonSummonItem extends PoketamableSummonItem
{
	...
	public static OkamiSylveonEntity toPoketamableEntity(World world, ItemStack poketamableStack, PlayerEntity player)
	{
		...
		String name = poketamableStack.getTag() != null ? poketamableStack.getDisplayName().getUnformattedComponentText() : "Okami Sylveon";

		if (name.equals("") || name.equals("Okami Sylveon Summon"))
		{
			name = "Okami Sylveon";
		}
		
		if(!name.equals("Okami Sylveon"))
		{
