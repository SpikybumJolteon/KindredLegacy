...
public class PoketamableSummonItem extends ItemBase
{
	...
	public static void retrieveEntityStats(TamablePokemon poketamableEntity, ItemStack poketamableStack)
	{
		...
		writeCompoundStringToItemStack(poketamableStack, "display", "Name", poketamableEntity.getTamableName());
    ...
    public ITextComponent getDisplayName(ItemStack itemStack) 
    {
        ...
        */
    	return new TranslationTextComponent(TextFormatting.GOLD + super.getDisplayName(itemStack).getUnformattedComponentText());
    }
