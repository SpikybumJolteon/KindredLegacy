...
public class PoketamableSummonItem extends ItemBase
{
	...
	{
		poketamableStack.setDisplayName(poketamableEntity.getCustomName());
    ...
    public ITextComponent getDisplayName(ItemStack itemStack) 
    {
        ...
        */
    	return new StringTextComponent(TextFormatting.GOLD + itemStack.getDisplayName().getUnformattedComponentText());
    }
