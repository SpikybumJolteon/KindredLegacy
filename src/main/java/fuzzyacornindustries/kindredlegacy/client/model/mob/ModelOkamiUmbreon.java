...
public class ModelOkamiUmbreon extends ModelBase 
{
	...
	{	
		...
		animateBody((EntityOkamiUmbreon)entity, par1, par2, par3, par4, par5, par6, idleDampener, verticleVelocity);
		animateHead((EntityOkamiUmbreon)entity, par1, par2, par3, par4, par5, par6, idleDampener, verticleVelocity);
		animateLegs((EntityOkamiUmbreon)entity, par1, par2, par3, par4, par5, par6, idleDampener, verticleVelocity);
		animateTail((EntityOkamiUmbreon)entity, par1, par2, par3, par4, par5, par6, idleDampener, angularVelocity, verticleVelocity);
	...
	public void animateBody(EntityOkamiUmbreon entity, float distanceMoved, float horzVelocity, float par3, float par4, float par5, float par6, float idleDampener, float verticalVelocity)
	{
		if(!entity.isSitting())
		{
	...
	public void animateHead(EntityOkamiUmbreon entity, float distanceMoved, float horzVelocity, float par3, float par4, float par5, float par6, float idleDampener, float verticalVelocity)
	{
		JointAnimation.reverseJointRotatesChange(bodyInfo, neckJointInfo);

		PartAnimate.headAnimateInfoOnlyWithAngleModifiers(neckInfo, par4, par5, 0.2F, 0.2F);
		...
		PartAnimate.headAnimateInfoOnlyWithAngleModifiers(headInfo, par4, par5, 0.9F, 0.9F);
	...
	public void animateLegs(EntityOkamiUmbreon entity, float distanceMoved, float horzVelocity, float par3, float par4, float par5, float par6, float idleDampener, float verticalVelocity)
	{
		if(!entity.isSitting())
		{
	...
	public void animateTail(EntityOkamiUmbreon entity, float distanceMoved, float horzVelocity, float par3, float par4, float par5, float par6, float idleDampener, float angularVelocity, float verticalVelocity)
	{
