...
public class SnowSorceressBraixenModel<T extends HostilePokemon> extends TintedAgeableModel<T>
{
	...
	public SnowSorceressBraixenModel() 
	{
	...
	public void animate(Entity entity, float distanceMoved, float horzVelocity, float ageInTicks, float yawHeadOffsetDifference, float pitchRotation)
	{	
...
//		if(animationDeployer.getEntity().getAnimationID() == SnowSorceressBraixenEntity.actionIDSpell)
//		{
...
//		}
		...
		animateBody((SnowSorceressBraixenEntity)entity, distanceMoved, horzVelocity, ageInTicks, yawHeadOffsetDifference, pitchRotation, sizeModifier, idleDampener);
		animateHead((SnowSorceressBraixenEntity)entity, distanceMoved, horzVelocity, ageInTicks, yawHeadOffsetDifference, pitchRotation, sizeModifier);
		animateArms((SnowSorceressBraixenEntity)entity, distanceMoved, horzVelocity, ageInTicks, yawHeadOffsetDifference, pitchRotation, sizeModifier, idleDampener);
		animateLegs((SnowSorceressBraixenEntity)entity, distanceMoved, horzVelocity, ageInTicks, yawHeadOffsetDifference, pitchRotation, sizeModifier, idleDampener);
		animateTail((SnowSorceressBraixenEntity)entity, distanceMoved, horzVelocity, ageInTicks, yawHeadOffsetDifference, pitchRotation, sizeModifier);
	...
	public void animateBody(SnowSorceressBraixenEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float yawHeadOffsetDifference, float pitchRotation, float modelSize, float idleDampener)
	{
	...
	public void animateArms(SnowSorceressBraixenEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float yawHeadOffsetDifference, float pitchRotation, float modelSize, float idleDampener)
	{
	...
	public void animateHead(SnowSorceressBraixenEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float yawHeadOffsetDifference, float pitchRotation, float modelSize)
	{
	...
	public void animateLegs(SnowSorceressBraixenEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float yawHeadOffsetDifference, float pitchRotation, float modelSize, float idleDampener)
	{
		float moveAmplitude = 0.8F;

		legRtInfo.setNewRotateX(legRtInfo.getNewRotateX() + PartAnimate.negCosRotateAnimationAdjusted(distanceMoved, horzVelocity, WALK_FREQUENCY, moveAmplitude) * idleDampener);
	...
	public void animateTail(SnowSorceressBraixenEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float yawHeadOffsetDifference, float pitchRotation, float modelSize)
	{
	...
	{
		return ImmutableList.of(this.bodyLowerJoint);
	}
}