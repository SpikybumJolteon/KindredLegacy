...
public class RenderBloodmoonNinetales extends RenderLiving<EntityBloodmoonNinetales>
{
	...
	private static final ResourceLocation orbTexture = new ResourceLocation(ModInfo.MOD_ID + ":" +"textures/mobs/bloodmoon_ninetales_orb.png");
	...
	@Override
	public void doRender(EntityBloodmoonNinetales entity, double xCoord, double yCoord, double zCoord, float entityYaw, float partialTicks)
	{
	...
	protected void renderSunGlaive(EntityLivingBase entity, float distanceMoved, float horzVelocity, float yawRotationDifference, float yawHeadOffsetDifference, float pitchRotation, float modelSize, float partialTicks)
	{
		...
		k = i / 65536;
		OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, (float)j / 1.0F, (float)k / 1.0F);
		this.setLightmap((EntityBloodmoonNinetales) entity);
