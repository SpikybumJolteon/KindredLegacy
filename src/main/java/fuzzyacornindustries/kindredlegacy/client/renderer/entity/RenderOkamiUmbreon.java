...
import fuzzyacornindustries.kindredlegacy.client.renderer.entity.layers.LayerOkamiUmbreonMoonGlaiveGlow;
...
public class RenderOkamiUmbreon extends RenderLiving<EntityOkamiUmbreon>
{
	...
	public ModelOkamiMoonGlaive modelMoonGlaiveGlow;
	...
	public RenderOkamiUmbreon(RenderManager renderManager, ModelBase modelBase, float shadowSize)
	{
        ...
        this.addLayer(new LayerOkamiUmbreonMoonGlaiveGlow(this));
	}
