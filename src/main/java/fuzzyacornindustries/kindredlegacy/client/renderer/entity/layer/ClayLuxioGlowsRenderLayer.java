...
@OnlyIn(Dist.CLIENT)
public class ClayLuxioGlowsRenderLayer<T extends ClayLuxioEntity, M extends ClayLuxioModel<T>> extends LayerRenderer<T, M>
{
	private final ClayLuxioModel<T> modelGlow = new ClayLuxioModel<T>();
	private static final ResourceLocation GLOW_TEXTURE = UtilityFunctions.location("textures/mobs/clay_luxio_glows.png");

	public ClayLuxioGlowsRenderLayer(IEntityRenderer<T, M> entityRenderer) 
	{
