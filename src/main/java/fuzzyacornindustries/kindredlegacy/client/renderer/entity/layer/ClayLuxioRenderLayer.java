...
@OnlyIn(Dist.CLIENT)
public class ClayLuxioRenderLayer extends LayerRenderer<ClayLuxioEntity, ClayLuxioModel<ClayLuxioEntity>>
{
	private final ClayLuxioModel<ClayLuxioEntity> modelGlow = new ClayLuxioModel<ClayLuxioEntity>();
	private static final ResourceLocation GLOW_TEXTURE = new ResourceLocation(ModInfo.MOD_ID + ":" +"textures/mobs/clay_luxio_glows.png");

	public ClayLuxioRenderLayer(IEntityRenderer<ClayLuxioEntity, ClayLuxioModel<ClayLuxioEntity>> entityRenderer) 
	{
		super(entityRenderer);
	}

	@Override
	public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, ClayLuxioEntity entity, float distanceMoved, float horzVelocity, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
		{
