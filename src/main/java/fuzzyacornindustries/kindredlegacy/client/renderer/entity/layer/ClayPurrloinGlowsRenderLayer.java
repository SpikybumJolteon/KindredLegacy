...
@OnlyIn(Dist.CLIENT)
public class ClayPurrloinGlowsRenderLayer<T extends ClayPurrloinEntity, M extends ClayPurrloinModel<T>> extends LayerRenderer<T, M>
{
	private final ClayPurrloinModel<T> modelGlow = new ClayPurrloinModel<T>();
	private static final ResourceLocation GLOW_TEXTURE = UtilityFunctions.location("textures/mobs/clay_purrloin_glows.png");

	public ClayPurrloinGlowsRenderLayer(IEntityRenderer<T, M> entityRenderer)
	{
