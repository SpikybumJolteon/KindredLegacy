...
@OnlyIn(Dist.CLIENT)
public class ClayShinxGlowsRenderLayer<T extends ClayShinxEntity, M extends ClayShinxModel<T>> extends LayerRenderer<T, M>
{
	private final ClayShinxModel<T> modelGlow = new ClayShinxModel<T>();
	private static final ResourceLocation GLOW_TEXTURE = UtilityFunctions.location("textures/mobs/clay_shinx_glows.png");

	public ClayShinxGlowsRenderLayer(IEntityRenderer<T, M> entityRenderer) 
	{
