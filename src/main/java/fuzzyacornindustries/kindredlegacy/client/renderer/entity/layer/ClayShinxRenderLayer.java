...
@OnlyIn(Dist.CLIENT)
public class ClayShinxRenderLayer extends LayerRenderer<ClayShinxEntity, ClayShinxModel<ClayShinxEntity>>
{
	private final ClayShinxModel<ClayShinxEntity> modelGlow = new ClayShinxModel<ClayShinxEntity>();
	private static final ResourceLocation GLOW_TEXTURE = new ResourceLocation(ModInfo.MOD_ID + ":" +"textures/mobs/clay_shinx_glows.png");

	public ClayShinxRenderLayer(IEntityRenderer<ClayShinxEntity, ClayShinxModel<ClayShinxEntity>> entityRenderer) 
	{
		super(entityRenderer);
	}

	@Override
	public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, ClayShinxEntity entity, float distanceMoved, float horzVelocity, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
		{
