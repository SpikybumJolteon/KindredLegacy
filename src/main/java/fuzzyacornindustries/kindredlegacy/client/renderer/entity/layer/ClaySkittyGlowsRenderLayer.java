...
@OnlyIn(Dist.CLIENT)
public class ClaySkittyGlowsRenderLayer<T extends ClaySkittyEntity, M extends ClaySkittyModel<T>> extends LayerRenderer<T, M>
{
	private final ClaySkittyModel<T> modelGlow = new ClaySkittyModel<T>();
	private static final ResourceLocation GLOW_TEXTURE = UtilityFunctions.location("textures/mobs/clay_skitty_glows.png");

	public ClaySkittyGlowsRenderLayer(IEntityRenderer<T, M> entityRenderer) 
	{
