...
@OnlyIn(Dist.CLIENT)
public class CracklingNincadaGlowsRenderLayer<T extends CracklingNincadaEntity, M extends ZerglingNincadaModel<T>> extends LayerRenderer<T, M>
{
	private final ZerglingNincadaModel<T> modelGlow = new ZerglingNincadaModel<T>();
	private static final ResourceLocation GLOW_TEXTURE = UtilityFunctions.location("textures/mobs/crackling_nincada_glows.png");

	public CracklingNincadaGlowsRenderLayer(IEntityRenderer<T, M> entityRenderer) 
	{
