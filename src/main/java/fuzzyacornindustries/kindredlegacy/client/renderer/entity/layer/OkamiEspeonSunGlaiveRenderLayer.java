...
import fuzzyacornindustries.kindredlegacy.client.model.mob.tool.OkamiSunGlaiveModel;
...
@OnlyIn(Dist.CLIENT)
public class OkamiEspeonSunGlaiveRenderLayer extends LayerRenderer<OkamiEspeonEntity, OkamiEspeonModel<OkamiEspeonEntity>>
{
	private final OkamiSunGlaiveModel<OkamiEspeonEntity> model = new OkamiSunGlaiveModel<OkamiEspeonEntity>();
	private final OkamiSunGlaiveModel<OkamiEspeonEntity> modelGlow = new OkamiSunGlaiveModel<OkamiEspeonEntity>();
	private static final ResourceLocation SUN_GLAIVE_TEXTURE = new ResourceLocation(ModInfo.MOD_ID + ":" +"textures/mobs/tamables/okami_weapon/sun_glaive.png");

	public OkamiEspeonSunGlaiveRenderLayer(IEntityRenderer<OkamiEspeonEntity, OkamiEspeonModel<OkamiEspeonEntity>> entityRenderer) 
	{
		super(entityRenderer);
	}

	@Override
	public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, OkamiEspeonEntity entity, float distanceMoved, float horzVelocity, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
		{
