...
public class LayerClayEspurrMarkings implements LayerRenderer<EntityClayEspurr>
{
	private static final ResourceLocation glowTexture = new ResourceLocation(ModInfo.MOD_ID + ":" +"textures/mobs/clay_espurr_glows.png");
    private final RenderClayEspurr entityRenderer;

    public LayerClayEspurrMarkings(RenderClayEspurr entityRenderer)
    {
        this.entityRenderer = entityRenderer;
    }

    @Override
    public void doRenderLayer(EntityClayEspurr entityLivingBase, float distanceMoved, float horzVelocity, float partialTicks, float yawRotationDifference, float yawHeadOffsetDifference, float pitchRotation, float modelSize)
    {
