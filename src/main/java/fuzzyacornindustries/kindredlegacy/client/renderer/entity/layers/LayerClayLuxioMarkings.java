...
public class LayerClayLuxioMarkings implements LayerRenderer<EntityClayLuxio>
{
	private static final ResourceLocation glowTexture = new ResourceLocation(ModInfo.MOD_ID + ":" +"textures/mobs/clay_luxio_glows.png");
    private final RenderClayLuxio entityRenderer;

    public LayerClayLuxioMarkings(RenderClayLuxio entityRenderer)
    {
        this.entityRenderer = entityRenderer;
    }

    @Override
    public void doRenderLayer(EntityClayLuxio entityLivingBase, float distanceMoved, float horzVelocity, float partialTicks, float yawRotationDifference, float yawHeadOffsetDifference, float pitchRotation, float modelSize)
    {
