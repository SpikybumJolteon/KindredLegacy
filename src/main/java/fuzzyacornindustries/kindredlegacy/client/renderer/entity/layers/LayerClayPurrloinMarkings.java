...
public class LayerClayPurrloinMarkings implements LayerRenderer<EntityClayPurrloin>
{
	private static final ResourceLocation glowTexture = new ResourceLocation(ModInfo.MOD_ID + ":" +"textures/mobs/clay_purrloin_glows.png");
    private final RenderClayPurrloin entityRenderer;

    public LayerClayPurrloinMarkings(RenderClayPurrloin entityRenderer)
    {
        this.entityRenderer = entityRenderer;
    }

    @Override
    public void doRenderLayer(EntityClayPurrloin entityLivingBase, float distanceMoved, float horzVelocity, float partialTicks, float yawRotationDifference, float yawHeadOffsetDifference, float pitchRotation, float modelSize)
    {
