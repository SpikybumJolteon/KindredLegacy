...
public class LayerClayShinxMarkings implements LayerRenderer<EntityClayShinx>
{
	private static final ResourceLocation glowTexture = new ResourceLocation(ModInfo.MOD_ID + ":" +"textures/mobs/clay_shinx_glows.png");
    private final RenderClayShinx entityRenderer;

    public LayerClayShinxMarkings(RenderClayShinx entityRenderer)
    {
        this.entityRenderer = entityRenderer;
    }

    @Override
    public void doRenderLayer(EntityClayShinx entityLivingBase, float distanceMoved, float horzVelocity, float partialTicks, float yawRotationDifference, float yawHeadOffsetDifference, float pitchRotation, float modelSize)
    {
