...
public class LayerOkamiUmbreonMoonGlaiveGlow implements LayerRenderer<EntityOkamiUmbreon>
{
    ...
    public LayerOkamiUmbreonMoonGlaiveGlow(RenderOkamiUmbreon entityRendererIn)
    {
    ...
    public void doRenderLayer(EntityOkamiUmbreon entityLivingBase, float distanceMoved, float horzVelocity, float partialTicks, float yawRotationDifference, float yawHeadOffsetDifference, float pitchRotation, float modelSize)
    {
        ...
        this.entityRenderer.modelMoonGlaiveGlow.render(entityLivingBase, distanceMoved, horzVelocity, yawRotationDifference, yawHeadOffsetDifference, pitchRotation, modelSize);
