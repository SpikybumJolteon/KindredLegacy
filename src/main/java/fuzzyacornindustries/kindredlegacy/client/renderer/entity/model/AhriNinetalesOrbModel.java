...
public class AhriNinetalesOrbModel<T extends TamablePokemon> extends TintedAgeableModel<T>
{
...
//		}
//		else if(entity instanceof BloodmoonNinetalesEntity)
//		{
//			sizeModifier = ((BloodmoonNinetalesEntity) entity).defaultHeight / entity.height;
//		}

		animateBody((IAnimateAhriNinetales)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, sizeModifier, idleDampener, verticalVelocity, gravityFactor);
		animateArms((IAnimateAhriNinetales)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, sizeModifier, idleDampener, verticalVelocity, gravityFactor);
		animateOrb((IAnimateAhriNinetales)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, sizeModifier, idleDampener);
	...
	public void animateBody(IAnimateAhriNinetales entity, float distanceMoved, float horzVelocity, 
			float ageInTicks, float netHeadYaw, float headPitch, float modelSize, float idleDampener, float verticalVelocity, float gravityFactor)
	{
	...
	public void animateOrb(IAnimateAhriNinetales entity, float distanceMoved, float horzVelocity, 
			float ageInTicks, float netHeadYaw, float headPitch, float modelSize, float idleDampener)
	{
