...
public class ClayEspurrModel<T extends HostilePokemon> extends TintedAgeableModel<T>
{
	...
	{	
		...
		animateHead((ClayEspurrEntity)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, sizeModifier);
		animateArms((ClayEspurrEntity)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, sizeModifier);
		animateLegs((ClayEspurrEntity)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, sizeModifier);
		animateTail((ClayEspurrEntity)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, sizeModifier);
	...
	public void animateHead(ClayEspurrEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float modelSize)
	{
		IdleAnimationClock currentIdleAnimationClock = entity.getIdleAnimationClockEars();

		PartAnimate.headAnimateInfoOnlyWithAngleModifiers(headInfo, netHeadYaw, headPitch, 0.6F, 0.6F);
	...
	public void animateArms(ClayEspurrEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float modelSize)
	{
		IdleAnimationClock currentIdleAnimationClock = entity.getIdleAnimationClockArms();

		float moveFrequencyY = 2.0F;
		float moveAmplitudeY = 0.65F;
	...
	public void animateLegs(ClayEspurrEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float modelSize)
	{
		float moveFrequency = 2.5F;
		float moveAmplitude = 0.9F;

		legRtInfo.setNewRotateX(legRtInfo.getNewRotateX() + PartAnimate.negCosRotateAnimationAdjusted(distanceMoved, horzVelocity, moveFrequency, moveAmplitude));
	...
	public void animateTail(ClayEspurrEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float modelSize)
	{
		for(int i = 0; i < tail.length; i++)
		{
