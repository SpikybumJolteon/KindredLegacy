...
public class ClayLuxioModel<T extends HostilePokemon> extends TintedAgeableModel<T>
{
	...
	{	
		...
		animateBody((ClayLuxioEntity)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, sizeModifier, verticalVelocity);
		animateHead((ClayLuxioEntity)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, sizeModifier, verticalVelocity);
		animateLegs((ClayLuxioEntity)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, sizeModifier, verticalVelocity);
		animateTail((ClayLuxioEntity)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, sizeModifier, verticalVelocity, angularVelocity);
	...
	public void animateBody(ClayLuxioEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float modelSize, float verticalVelocity)
	{
	...
	public void animateHead(ClayLuxioEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float modelSize, float verticalVelocity)
	{
	...
	public void animateLegs(ClayLuxioEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float modelSize, float verticalVelocity)
	{
	...
	public void animateTail(ClayLuxioEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float modelSize, float verticalVelocity, float angularVelocity)
	{
