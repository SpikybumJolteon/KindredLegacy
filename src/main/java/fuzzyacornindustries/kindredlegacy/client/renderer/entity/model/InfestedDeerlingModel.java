...
public class InfestedDeerlingModel<T extends HostilePokemon> extends TintedAgeableModel<T>
{
	...
	public void animate(Entity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch)
	{
		...
		animateBody((InfestedDeerlingEntity)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, sizeModifier, verticalVelocity);
		animateHead((InfestedDeerlingEntity)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, sizeModifier, verticalVelocity);
		animateLegs((InfestedDeerlingEntity)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, sizeModifier, verticalVelocity);
		animateTail((InfestedDeerlingEntity)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, sizeModifier, verticalVelocity, angularVelocity);
	...
	public void animateBody(InfestedDeerlingEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float modelSize, float verticalVelocity)
	{
	...
	public void animateHead(InfestedDeerlingEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float modelSize, float verticalVelocity)
	{
	...
	public void animateLegs(InfestedDeerlingEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float modelSize, float verticalVelocity)
	{
	...
	public void animateTail(InfestedDeerlingEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float modelSize, float verticalVelocity, float angularVelocity)
	{
