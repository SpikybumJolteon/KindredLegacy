...
public class OkamiSylveonModel<T extends TamablePokemon> extends TintedAgeableModel<T>
{
	...
	{
		animate((OkamiSylveonEntity)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch);
	}
	...
	public void animate(OkamiSylveonEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch)
	{
		...
		if(!entity.isSitting())
		{
			...
			{
				idleDampener = animateSlash(animationDeployer.getEntity(), distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch);
			}
		}
		
		//System.out.println( "Entity ID: " + Integer.toString( entity.getEntityId() ) );

		animateBody(entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, idleDampener, angularVelocity, verticleVelocity);
		animateHead(entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, idleDampener, verticleVelocity);
		animateLegs(entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, idleDampener, verticleVelocity);
		animateTail(entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, idleDampener, angularVelocity, verticleVelocity);
	...
	public float animateSlash(IAnimatedEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch)
	{
		float idleDampener = 1F;
	...
	public void animateBody(OkamiSylveonEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float idleDampener, float angularVelocity, float verticalVelocity)
	{
		if(!entity.isSitting())
		{
	...
	public void animateHead(OkamiSylveonEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float idleDampener, float verticalVelocity)
	{
	...
	public void animateLegs(OkamiSylveonEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float idleDampener, float verticalVelocity)
	{
		if(!entity.isSitting())
		{
	...
	public void animateTail(OkamiSylveonEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float idleDampener, float angularVelocity, float verticalVelocity)
	{
		...
		for(int i = 0; i < tail.length; i++)
		{
			...
			// Movement Animations
			angleChangeX += PartAnimate.negCosRotateAnimationAdjusted(distanceMoved - (2F * PI * ((float)i / (float)(tail.length - 1))), absoluteMoveVelocity, RUN_FREQUENCY * entity.getGravityFactor(), moveAmplitudeX) 
					+ verticalVelocityChangeAngle * newVerticalVelocity;
