...
public class OkamiUmbreonModel<T extends TamablePokemon> extends TintedAgeableModel<T>
{
	...
	{
		animate((OkamiUmbreonEntity)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch);
	}
	...
	public void animate(OkamiUmbreonEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch)
	{	
	...
	public void animateBody(OkamiUmbreonEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float modelSize, float idleDampener, float verticalVelocity)
	{
		if(!entity.isSitting())
		{
	...
	public void animateHead(OkamiUmbreonEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float modelSize, float idleDampener, float verticalVelocity)
	{
		...
		for(int i = 0; i < ear.length; i++)
		{
			for(int j = 0; j < ear[i].length; j++)
			{
				earInfo[i][j][1].setNewRotateX(earInfo[i][j][1].getNewRotateX() + angleChangeZ * 0.2F);
	...
	public void animateLegs(OkamiUmbreonEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float modelSize, float idleDampener, float verticalVelocity)
	{
		if(!entity.isSitting())
		{
	...
	public void animateTail(OkamiUmbreonEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float modelSize, float idleDampener, float angularVelocity, float verticalVelocity)
	{
