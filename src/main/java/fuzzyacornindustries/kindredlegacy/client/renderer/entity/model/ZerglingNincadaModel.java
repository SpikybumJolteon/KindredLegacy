...
@OnlyIn(Dist.CLIENT)
public class ZerglingNincadaModel<T extends HostilePokemon> extends TintedAgeableModel<T>
{
	...
	{	
		...
		animateBody((ZerglingNincadaEntity)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, verticalVelocity);
		animateHead((ZerglingNincadaEntity)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, verticalVelocity);
		animateLegsAndBackArms((ZerglingNincadaEntity)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, verticalVelocity);
		animateWings((ZerglingNincadaEntity)entity, distanceMoved, horzVelocity, ageInTicks, netHeadYaw, headPitch, verticalVelocity);
	...
	public void animateBody(ZerglingNincadaEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float verticalVelocity)
	{
	...
	public void animateHead(ZerglingNincadaEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float verticalVelocity)
	{
	...
	public void animateLegsAndBackArms(ZerglingNincadaEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float verticalVelocity)
	{
	...
	public void animateWings(ZerglingNincadaEntity entity, float distanceMoved, float horzVelocity, float ageInTicks, float netHeadYaw, float headPitch, float verticalVelocity)
	{
