...
{
	public static final ResourceLocation MAIN_TEXTURE = new ResourceLocation(ModInfo.MOD_ID, "textures/projectiles/firework_missile.png");
...
//	      }
	   ...
	   public static class RenderFactory implements IRenderFactory<FireworkMissileEntity>
		{
			@Override
			public EntityRenderer<? super FireworkMissileEntity> createRenderFor(EntityRendererManager manager) 
			{
				return new FireworkMissileRenderer(manager);
			}
		}
}