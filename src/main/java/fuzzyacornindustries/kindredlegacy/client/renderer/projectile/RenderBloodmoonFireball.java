...
public class RenderBloodmoonFireball extends Render<EntityBloodmoonFireball>
{
    private final float scale;

    public RenderBloodmoonFireball(RenderManager renderManagerIn)
    {
    ...
    @Override
    public void doRender(EntityBloodmoonFireball entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
	@Override
	protected ResourceLocation getEntityTexture(EntityBloodmoonFireball fireballEntity)
	{
		int textureNumber = fireballEntity.getCurrentTexture();

		return new ResourceLocation(ModInfo.MOD_ID + ":" + "textures/particles/bloodmoon_flame/bloodmoon_flame" + textureNumber + ".png");
	}
}