...
public class RenderFireworkMissile extends Render<EntityFireworkMissile> 
{
	public static final ResourceLocation fireworkMissile = new ResourceLocation(ModInfo.MOD_ID, "textures/projectiles/firework_missile.png");

	public RenderFireworkMissile(RenderManager rm) 
	{
		super(rm);
	}

	public void doRender(EntityFireworkMissile entity, double x, double y, double z, float entityYaw, float partialTicks)
	{
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityFireworkMissile entity) 
	{
		return fireworkMissile;
	}
}