...
public class VastayaFireballRenderer extends EntityRenderer<VastayaFireballEntity> 
{
	public static final IRenderFactory<VastayaFireballEntity> RENDER_FACTORY = manager -> new VastayaFireballRenderer(manager);
    //private final float scale;

    public VastayaFireballRenderer(EntityRendererManager renderManagerIn) 
    {
    ...
    @Override
    public void render(VastayaFireballEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) 
    {
        matrixStackIn.push();
	...
	@Override
	public ResourceLocation getEntityTexture(VastayaFireballEntity fireballEntity)
	{
		int textureNumber = fireballEntity.getCurrentTexture();

		return new ResourceLocation(Names.MOD_ID + ":" + "textures/particle/vastaya_flame/vastaya_flame" + textureNumber + ".png");
	}
}