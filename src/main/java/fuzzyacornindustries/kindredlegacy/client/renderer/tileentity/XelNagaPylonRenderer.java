...
import fuzzyacornindustries.kindredlegacy.client.model.block.XelNagaPylonModel;
...
{
	public static final ResourceLocation TEXTURE_MAIN = new ResourceLocation(ModInfo.MOD_ID + ":" +"textures/block/xelnaga_pylon.png");
	public static final ResourceLocation TEXTURE_GLOWS = new ResourceLocation(ModInfo.MOD_ID + ":" +"textures/block/xelnaga_pylon_glows.png");
