...
public class ArmoredLuxrayEntity extends HostilePokemon implements IAnimatedEntity, IMiniBoss
{
	...
	public ArmoredLuxrayEntity(EntityType<? extends ArmoredLuxrayEntity> type, World world)
	{
		super(type, world);
	...
	public ArmoredLuxrayEntity(World world) 
	{
		this(ModEntities.ARMORED_LUXRAY.get(), world);
	}
	...
	public boolean attackEntityAsMob(Entity targetEntity)
	{
		...
		BlockPos blockpos = new BlockPos(targetEntity.getPosX(), (double)Math.round(targetEntity.getPosY()), targetEntity.getPosZ());

		if (this.world.canSeeSky(blockpos) && !(targetEntity instanceof ZombieEntity) && !(targetEntity instanceof OkamiUmbreonEntity) && !(targetEntity instanceof IronGolemEntity) )
		{
			if(!this.world.isRemote)
				((ServerWorld)this.world).addLightningBolt(new LightningBoltEntity(world, (int)targetEntity.getPosX(), (int)targetEntity.getPosY(), (int)targetEntity.getPosZ(), false));
		}
	...
	{
		return ModSounds.ARMORED_LUXRAY_AMBIENT.get();
	}

	@Override
	protected SoundEvent getHurtSound(DamageSource damageSourceIn)
	{
		return ModSounds.ARMORED_LUXRAY_HURT.get();
	}

	@Override
	protected SoundEvent getDeathSound()
	{
		return ModSounds.ARMORED_LUXRAY_DEATH.get();
	}
