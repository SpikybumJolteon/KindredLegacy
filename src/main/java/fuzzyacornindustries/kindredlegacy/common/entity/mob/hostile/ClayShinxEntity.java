...
public class ClayShinxEntity extends HostilePokemon implements IAnimatedEntity
{
	...
	static String mobName = "clay_shinx";

	public ClayShinxEntity(EntityType<? extends ClayShinxEntity> type, World world)
	{
		super(type, world);
	...
	public ClayShinxEntity(World world) 
	{
		this(ModEntities.CLAY_SHINX.get(), world);
	}
	...
	protected void registerGoals() 
	{
		...
		this.goalSelector.addGoal(3, new LeapAttackGoal(this, 0.65F, 2.5F, 6D, 20D, 5, null));
	...
	{
		return ModSounds.CLAY_SHINX_AMBIENT.get();
	}

	@Override
	protected SoundEvent getHurtSound(DamageSource damageSourceIn)
	{
		return ModSounds.CLAY_SHINX_HURT.get();
	}

	@Override
	protected SoundEvent getDeathSound()
	{
		return ModSounds.CLAY_SHINX_DEATH.get();
	}
