...
import fuzzyacornindustries.kindredlegacy.client.ClientUtils;
 ...
 * 
 * Code taken from PnuematicCraft
 */
public class SpawnParticlePacket extends LocationDoublePacket 
{
    ...
    public SpawnParticlePacket(IParticleData particle, double x, double y, double z, double dx, double dy, double dz) {
        super(x, y, z);
    ...
    public SpawnParticlePacket(IParticleData particle, double x, double y, double z, double dx, double dy, double dz, int numParticles, double rx, double ry, double rz) {
