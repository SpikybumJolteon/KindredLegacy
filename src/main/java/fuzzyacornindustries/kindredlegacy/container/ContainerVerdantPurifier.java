...
{
	private final TileEntityVerdantPurifier tileEntity;
	...
	public ContainerVerdantPurifier(InventoryPlayer player, TileEntityVerdantPurifier tileEntity) 
	{
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int slotIndex)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (VerdantPurifierRecipes.getInstance().getPurificationResult(itemStack2) != null)
                {
