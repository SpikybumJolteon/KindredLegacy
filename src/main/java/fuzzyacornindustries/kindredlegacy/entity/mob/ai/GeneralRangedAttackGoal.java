...
//    public void tick()
//    {
//        double d0 = this.entityHost.getDistanceSq(this.attackTarget.func_226277_ct_(), this.attackTarget.getBoundingBox().minY, this.attackTarget.func_226281_cx_());
...
//        }
//
//        if (d0 <= (double)this.maxAttackDistance && this.seeTime != 0 || !this.attackTarget.isAlive())
//        {
