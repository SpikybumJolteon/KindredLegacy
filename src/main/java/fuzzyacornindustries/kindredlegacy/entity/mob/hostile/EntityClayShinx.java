...
public class EntityClayShinx extends HostilePokemon implements IAnimatedEntity
{
	...
	public EntityClayShinx(World par1World)
	{
		...
		this.tasks.addTask(3, new AILeapAttack(this, 0.65F, 2.5F, 6D, 20D, 5, null));
    ...
    {
        return KindredLegacyLootTables.CLAY_SHINX_LOOT_TABLE;
    }
