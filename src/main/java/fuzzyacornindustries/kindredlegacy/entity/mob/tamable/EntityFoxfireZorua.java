...
import fuzzyacornindustries.kindredlegacy.entity.mob.ai.AIFoxfireZoruaFoxfireSummon;
...
public class EntityFoxfireZorua extends TamablePokemon implements IRangedAttackMob
{
	...
	static String mobName = "foxfire_zorua";
	...
	public EntityFoxfireZorua(World par1World)
	{
		...
		this.tasks.addTask(2, new AIFoxfireZoruaFoxfireSummon(this));
	...
	protected SoundEvent getAmbientSound()
	{
		...
		{
			return KindredLegacySoundEvents.FOXFIRE_ZORUA_WHINE;
		}
		...
		{
			return KindredLegacySoundEvents.FOXFIRE_ZORUA_AMBIENT;
		}
	}
	...
	{
		return KindredLegacySoundEvents.FOXFIRE_ZORUA_HURT;
	}

	@Override
	protected SoundEvent getDeathSound()
	{
		return KindredLegacySoundEvents.FOXFIRE_ZORUA_DEATH;
	}
	...
	public void attackEntityWithRangedAttack(EntityLivingBase targetEntity, float par2)
	{
		if(animationID == LibraryUniversalAttackID.NO_ACTION)
		{
			...
			{
					KindredLegacyMain.sendAnimationPacket(this, LibraryFoxfireZoruaAttackID.SUMMON_FOXFIRE);
			}
		}
	}
