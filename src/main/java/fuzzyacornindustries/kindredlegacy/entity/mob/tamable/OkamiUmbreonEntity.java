...
public class OkamiUmbreonEntity extends OkamiPokemon implements IRangedAttackMob
{
	...
	{
		setDefaultBaseAttackPower(2F);
		setDefaultBaseMaxHealth(30F);
		setDefaultBaseSpeed(0.30F);

		setDefaultRegenLevel(3);

		setDefaultMaximumAttackBoost(8F);
		setDefaultMaximumHealthBoost(100F);
		setDefaultMaximumSpeedBoost(0.36F);
	...
	public void returnToItem()
	{
		...
		ItemStack poketamableStack = OkamiUmbreonSummonItem.fromPoketamableEntity(this);
