...
//public class BloodmoonFireballEntity extends KindredLegacyFireball
//{
...
//
//	public BloodmoonFireballEntity(EntityType<? extends BloodmoonFireballEntity> fireballEntity, World worldPar)
//	{
//		super(fireballEntity, worldPar);
//
//		//this.setSize(0.3125F, 0.3125F);
//	}
//
//	public BloodmoonFireballEntity(EntityType<? extends BloodmoonFireballEntity> fireballEntity, World worldPar, double setLocationX, double setLocationY, double setLocationZ,
//			double accelerationXPar, double accelerationYPar, double accelerationZPar, float fireballSpeedModifier)
//	{
//		super(fireballEntity, worldPar, setLocationX, setLocationY, setLocationZ, accelerationXPar, accelerationYPar, accelerationZPar, fireballSpeedModifier);
//
//		//this.setSize(0.3125F, 0.3125F);
//	}
//
//	public BloodmoonFireballEntity(EntityType<? extends BloodmoonFireballEntity> fireballEntity, World worldPar, LivingEntity shootingEntity, double accelerationXPar, double accelerationYPar, double accelerationZPar, float fireballSpeedModifier)
//	{
//		super(fireballEntity, worldPar, shootingEntity, accelerationXPar, accelerationYPar, accelerationZPar, fireballSpeedModifier);
//
//		//this.setSize(0.3125F, 0.3125F);
//	}
//
//	public BloodmoonFireballEntity(EntityType<? extends BloodmoonFireballEntity> fireballEntity, World worldPar, LivingEntity shootingEntity, double setLocationX, double setLocationY, double setLocationZ,
//			double accelerationXPar, double accelerationYPar, double accelerationZPar, float fireballSpeedModifier, float attackDamage)
//	{
//		super(fireballEntity, worldPar, shootingEntity, setLocationX, setLocationY, setLocationZ, accelerationXPar, accelerationYPar, accelerationZPar, fireballSpeedModifier);
//
...
//						result.entityHit instanceof BloodmoonFireballEntity || 
