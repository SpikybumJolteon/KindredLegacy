...
public class FireworkMissileEntity extends ThrowableEntity 
{
	...
	public  FireworkMissileEntity(EntityType<?> type, World worldIn) 
	{
		super((EntityType<? extends FireworkMissileEntity>) type, worldIn);
	}

	public  FireworkMissileEntity(double x, double y, double z, World worldIn) 
	{
		this(KindredLegacyEntities.FIREWORK_MISSILE, worldIn);
	...
	protected void onEntityHit(EntityRayTraceResult p_213868_1_) 
	{
		...
		if (p_213868_1_.getEntity() != null && !(p_213868_1_.getEntity() instanceof TamablePokemon) && p_213868_1_.getEntity() != this.firecrackerLitten && !(p_213868_1_.getEntity() instanceof PlayerEntity)) 
		{
			if(p_213868_1_.getEntity() instanceof LivingEntity && this.firecrackerLitten != null && this.firecrackerLitten.getOwner() != null && ((LivingEntity)p_213868_1_.getEntity()).getHealth() <= this.getDamage())
			{
				p_213868_1_.getEntity().attackEntityFrom(DamageSource.causeMobDamage(this.firecrackerLitten.getOwner()), (float)this.getDamage());

			}
			else if(p_213868_1_.getEntity().attackEntityFrom(DamageSource.causeMobDamage(this.firecrackerLitten), (float)this.getDamage()))
			{
			}
