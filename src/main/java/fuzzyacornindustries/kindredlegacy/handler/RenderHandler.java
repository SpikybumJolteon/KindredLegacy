...
import fuzzyacornindustries.kindredlegacy.client.model.mob.ModelImmortalArcanine;
...
import fuzzyacornindustries.kindredlegacy.client.model.mob.ModelTiberiumGrowlithe;
...
import fuzzyacornindustries.kindredlegacy.client.renderer.entity.RenderImmortalArcanine;
...
import fuzzyacornindustries.kindredlegacy.client.renderer.entity.RenderTiberiumGrowlithe;
...
import fuzzyacornindustries.kindredlegacy.client.renderer.tileentity.TileEntityAlchemenisizerRenderer;
import fuzzyacornindustries.kindredlegacy.client.renderer.tileentity.TileEntityVerdantPurifierRenderer;
import fuzzyacornindustries.kindredlegacy.client.renderer.tileentity.TileEntityVespeneCondenserRenderer;
import fuzzyacornindustries.kindredlegacy.client.renderer.tileentity.TileEntityXelNagaPylonRenderer;
...
public class RenderHandler 
{
	public static void registerEntityRenders()
	{
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityImmortalArcanine.class, new IRenderFactory<EntityImmortalArcanine>()
		{
			@Override
			public Render<? super EntityImmortalArcanine> createRenderFor(RenderManager manager)
			{
				return new RenderImmortalArcanine(manager, new ModelImmortalArcanine(), 0.6F);
			}
		});
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityTiberiumGrowlithe.class, new IRenderFactory<EntityTiberiumGrowlithe>()
		{
			@Override
			public Render<? super EntityTiberiumGrowlithe> createRenderFor(RenderManager manager)
			{
				return new RenderTiberiumGrowlithe(manager, new ModelTiberiumGrowlithe(), 0.3F);
			}
		});
	...
	public static void registerTileEntityRenders()
	{
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityAlchemenisizer.class, new TileEntityAlchemenisizerRenderer());
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityVerdantPurifier.class, new TileEntityVerdantPurifierRenderer());
	}
	
	public static Particle generateFireworkEffect(World world, double posX, double posY, double posZ, double motionX, double motionY, double motionZ, NBTTagCompound nbttagcompound5)
	{
		return new ParticleFirework.Starter(world, posX, posY, posZ, motionX, motionY, motionZ, Minecraft.getMinecraft().effectRenderer, nbttagcompound5);
	}
}