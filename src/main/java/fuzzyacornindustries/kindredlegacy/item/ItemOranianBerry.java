...
public class ItemOranianBerry extends BerryItem implements IPlantable
{	
	public ItemOranianBerry(String name, int healAmount, float saturation)
	{
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		{
			worldIn.setBlockState(pos.up(), KindredLegacyBlocks.ORANIAN_BERRY_PLANT.getDefaultState());
			stack.shrink(1);
	...
	{
		return KindredLegacyBlocks.ORANIAN_BERRY_PLANT.getDefaultState();
	}
}