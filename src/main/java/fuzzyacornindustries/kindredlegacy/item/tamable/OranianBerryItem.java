...
{	
	public OranianBerryItem(Item.Properties properties, float pokemonHealAmount)
	{
		super(properties, pokemonHealAmount);
	}
	...
	public ActionResultType onItemUse(ItemUseContext context) 
	{
		...
		{
			context.getWorld().setBlockState(context.getPos().up(), KindredLegacyBlocks.ORANIAN_BERRIES.getDefaultState());
			stack.shrink(1);
	...
	{
		return KindredLegacyBlocks.ORANIAN_BERRIES.getDefaultState();
	}
}